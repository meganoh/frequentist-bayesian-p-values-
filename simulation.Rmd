...
fit <- function(i, sample_size) {
  ...
  p_oosterwijk <- pchisq(diff_student, df = 1, lower.tail = FALSE)
  p_oosterwijk_max <-pchisq(diff_student_max, df = 1, lower.tail = FALSE)
...
run <- function(iter, sample_size) {
  ...
  save(results, file = paste0("2_group_simulation", "_n", sample_size, "_iter", iter, ".rda"))
}
